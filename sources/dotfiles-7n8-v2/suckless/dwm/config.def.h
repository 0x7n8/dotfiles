...
static const unsigned int gappoh    = 15;       /* horiz outer gap between windows and screen edge alias bar atas*/
static const unsigned int gappov    = 20;       /* vert outer gap between windows and screen edge alias bar samping*/
...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:size=10", "fontello:size=30", "icomoon:size=11"}; /*{ "monospace:size=10" };*/
...
static const char *dmenucmd[] = { "dmenu_run", "-fn", dmenufont, "-bw", "3", "-c", "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbordercolor, "-sf", selfgcolor, "-l", "20", NULL };
